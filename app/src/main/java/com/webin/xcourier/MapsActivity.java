...
public class MapsActivity extends FragmentActivity {
    ...
    private void setUpMap() {
       ...
       /// mMap.addMarker(new MarkerOptions().position(new LatLng(-12.10445227, -76.99459076)).title("Marker"));
        double lat = Double.valueOf(latitud);
        double longi = Double.valueOf(longitud);
        LatLng l0 = new LatLng(lat, longi);

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(l0, 18));
